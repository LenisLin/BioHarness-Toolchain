...
TOPICS = [
    ...
    },
    {
        ...
        "direct_results": [
            ...
            "User-prioritized direct search also added SpatialZ as a published dense-3D-atlas method with explicit virtual-slicing outputs.",
        ],
        "methods": [
            m(
            ...
            m(
                "Multi-slice alignment / integration",
                "3D atlas reconstruction and virtual slicing",
                "SpatialZ",
                "Bridging the dimensional gap from planar spatial transcriptomics to 3D cell atlases",
                "10.1038/s41592-025-02969-9",
                "",
                2026,
                "Nature Methods",
                "Direct search",
                "User-prioritized direct search after 3D-atlas and virtual-slicing audit",
                "Yes",
                "https://github.com/broadinstitute/Spatial-Z",
                "Optional GPU",
                "Include",
                notes="Added as a published dense-3D-atlas method that supports in silico virtual slicing beyond ordinary slice alignment or section stacking.",
            ),
            m(
                "Multi-slice alignment / integration",
    ...
    },
    {
        ...
        "whitelist_results": [
            "Cell Systems sweep surfaced SpaTrack as the initial published anchor for spatial trajectory inference.",
            "Later whitelist checks added STT and spVelo as consolidation-ready trajectory methods with public code.",
    ...
    },
    {
        ...
        "direct_results": [
            ...
            "User-prioritized topography audit also added GASTON as a published continuous-gradient and domain-boundary method for layered tissues.",
        ],
        "methods": [
            m(
            ...
            m(
                "Spatial domain identification",
                "Interpretable topographic deep learning",
                "GASTON",
                "Mapping the topography of spatial gene expression with interpretable deep learning",
                "10.1038/s41592-024-02503-3",
                "",
                2025,
                "Nature Methods",
                "Direct search",
                "User-prioritized direct search after topographic-domain and gradient-boundary audit",
                "Yes",
                "https://github.com/StannisZhou/GASTON",
                "Optional GPU",
                "Include",
                notes="Added as a topographic domain method that preserves continuous gradients and domain boundaries instead of reducing layered tissues to only plain discrete clusters.",
            ),
            m(
                "Spatial domain identification",
                "Deep spatial architecture learning",
    ...
    },
    {
        ...
        "direct_results": [
            ...
            "The 2025 Nature Reviews Genetics deconvolution review also surfaced later published methods such as Redeconve, SpatialPrompt, SPADE, SONAR, CellsFromSpace, Celloscope, stVAE, SMART, STIE, and SpatialScope.",
    ...
    },
    {
        ...
        "direct_results": [
            ...
            "Later comparative branch relaxation admitted SPADE and STcompare as between-group spatial pattern comparison methods.",
        ],
        "methods": [
            m(
    ...
    },
    {
        ...
        "whitelist_results": [
            "Nature Methods sweep surfaced Clonalscope as the initial published anchor for spatial subclone detection.",
            "Later whitelist checks added CalicoST as a consolidation-ready clonal-analysis method with public code.",
    ...
    },
    {
        ...
        "direct_results": [
            ...
            "User-prioritized baseline checks added NicheNet and CellChat as important transcriptomics communication baselines, and later direct checks added CellNEST, DeepTalk, and SPIDER as additional published communication methods.",
            "User-prioritized 2026 update admitted Renoir as a published spatial ligand-target activity framework that maps downstream target activity and communication niches while remaining within the current CCC topic.",
            ...
            "A later cellular-neighbor-preference benchmark/code review admitted COZI into the neighborhood / interaction-effect modeling branch.",
        ],
        "methods": [
            m(
                "Ligand-receptor communication inference",
            ...
            m(
                "Ligand-receptor communication inference",
                "Ligand-target activity mapping",
                "Renoir",
                "Charting spatial ligand-target activity using Renoir",
                "10.1038/s41467-026-72388-7",
                "",
                2026,
                "Nature Communications",
                "Direct search",
                "User-prioritized Renoir admission after 2026 Nature Communications validation",
                "Yes",
                "https://github.com/Zafar-Lab/Renoir",
                "CPU",
                "Include",
                notes="Added as a published spatial ligand-target activity framework that infers communication niches and pathway-level activity from spot- or cell-resolution spatial transcriptomics data.",
            ),
            m(
                "Ligand-receptor communication inference",
    ...
    },
    {
        ...
        "direct_results": [
            ...
            "User-prioritized whole-slide reconstruction audit also added PanoSpace as a measured-anchor single-cell reconstruction method with matched histology and scRNA guidance.",
        ],
        "methods": [
            m(
            ...
            m(
                "Resolution enhancement of spot-based spatial transcriptomics",
                "Reference- and histology-guided continuous whole-slide reconstruction",
                "PanoSpace",
                ...
                "Nature Computational Science",
                "Direct search",
                "User-prioritized direct search after whole-slide single-cell reconstruction audit",
                "Yes",
                "https://github.com/hehuifeng/PanoSpace",
                "Optional GPU",
                "Include",
                notes="Added as a measured-anchor whole-slide reconstruction method that uses matched histology and scRNA-seq while remaining in the super-resolution topic rather than plain cell-type mapping.",
            ),
        ],
